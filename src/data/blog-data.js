const blog_data = [
  {
    ...
    short_desc:
      "At JJ Tech we specialize in designing, building, shipping and scaling beautiful, usable products with blazing-fast",
    duration: ".6s",
    delay: ".4s",
    home: true,
  },
  {
    ...
    comment: "09",
    views: "2,226",
    title: "How to grow your business with JJ Tech digital solution.",
    short_desc:
      "At JJ Tech we specialize in designing, building, shipping and scaling beautiful, usable products with blazing-fast",
    duration: ".7s",
    delay: ".6s",
  ...
  // home three
  {
    ...
    short_desc:
      "At JJ Tech we specialize in designing, building, shipping and scaling beautiful",
    duration: ".3s",
    delay: ".6s",
    home_3: true,
  },
  ...
  // home 4
  {
    ...
    title: "Godaddy user flow solution.",
    short_desc:
      "At JJ Tech we specialize in designing, building, shipping and scaling beautifu. At JJ Tech we specialize in designing, building, shipping and scaling beautiful.",
    big: true,
    home_4: true,
  },
  {
