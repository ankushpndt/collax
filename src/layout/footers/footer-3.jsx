...
const footer_contents = {
  ...
  copy_right_text: (
    <>
      © Copyright ©{new Date().getFullYear()} JJ Tech. All Rights Reserved
      Copyright
    </>
  ),
      ...
      <footer>
        <div className="tp-footer-area black-bg pt-130 pb-30">
          <div className="container">
            <div
              className="row wow tpfadeUp tp-footer-space-between"
                ...
                <div className="tp-footer-widget">
                  ...
                  {home_four && (
                    <div className="tp-footer-widget__title mb-30">
                      <h3 className="footer-title">About JJ Tech</h3>
                    </div>
                  )}
